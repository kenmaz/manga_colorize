...
parser.add_argument('--load_size_h', dest='load_size_h', type=int, default=1320, help='scale images to this size height(x1.1)')
parser.add_argument('--load_size_w', dest='load_size_w', type=int, default=880, help='scale images to this size width(x1.1)')
parser.add_argument('--fine_size_h', dest='fine_size_h', type=int, default=1200, help='then crop to this size height')
parser.add_argument('--fine_size_w', dest='fine_size_w', type=int, default=800, help='then crop to this size width')
...
parser.add_argument('--use_cpu', dest='use_cpu', type=bool, default=False, help='0: use only cpu, 1:use gpu too')
