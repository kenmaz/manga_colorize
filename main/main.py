...
parser.add_argument('--load_size_h', dest='load_size_h', type=int, default=1620, help='scale images to this size height')
parser.add_argument('--load_size_w', dest='load_size_w', type=int, default=1080, help='scale images to this size width')
parser.add_argument('--fine_size_h', dest='fine_size_h', type=int, default=1536, help='then crop to this size height')
parser.add_argument('--fine_size_w', dest='fine_size_w', type=int, default=1024, help='then crop to this size width')
